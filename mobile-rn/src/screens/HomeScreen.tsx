...
const FEATURED: FeaturedItem[] = [
  { id: '1', title: 'Get Started with CalMaster', subtitle: 'Scientific calculator & unit converter', badge: 'NEW' },
  ...
  return (
    <SafeAreaView style={homeStyles.safe} testID='home-screen'>
      ...
      <View style={homeStyles.header}>
        <Text style={homeStyles.appName} testID='app-name'>CalMaster</Text>
        <Text style={homeStyles.tagline}>Scientific calculator & unit converter</Text>
      </View>
      {loading ? (
