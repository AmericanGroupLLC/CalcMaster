// CalMaster — Cross-Platform Simulation Tests

import { Platform } from 'react-native';

describe('CalMaster — Cross-Platform', () => {
  ...
  describe('Theme colors', () => {
    test('primary color valid hex', () => expect('#37474F').toMatch(/^#[0-9A-Fa-f]{6}$/));
    test('accent color valid hex', () => expect('#90A4AE').toMatch(/^#[0-9A-Fa-f]{6}$/));
